...
class TestDetectTrend:
    ...
    def test_flat_returns_none(self, flat_h1_df):
        result = detect_trend(flat_h1_df)
        # Flat/ranging should return None or be ambiguous
        # (may return a weak direction — acceptable)
        assert result is None or isinstance(result, TradeDirection)
